                ...
                $.ajax({
                    ...
                    success: function(ret) {
                        if (ret.errors) {
                            ...
                            if (ret.status=='ok') {
                                $form.replaceWith('<div class="form-send-success"><strong>Wiadomość została poprawnie wysłana</strong><span>Dziękujemy za kontakt.</span><span><img src="../img/succes.png" alt=""height="100 width="100"></span></div>');
                            }
                            if (ret.status=='error') {
